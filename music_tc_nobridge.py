...
class Music(commands.Cog):
    ...
    @commands.slash_command(name='join', invoke_without_subcommand=True, description="加入目前的語音頻道")
    async def joinslash(self, ctx):
        await self._join(context=ctx)

    @commands.command(name='join', invoke_without_subcommand=True, description="加入目前的語音頻道")
    ...
    @commands.slash_command(name='summon', description="召喚機器人到目前的語音頻道 (需要\"移動成員\"權限)")
    async def summonslash(self, ctx, channel=None):
        await self._summon(context=ctx, channel=channel)
    
    @commands.command(name='summon', description="召喚機器人到目前的語音頻道 (需要\"移動成員\"權限)")
    ...
    @commands.command(name='leave', aliases=['disconnect', 'dc'], description="離開語音頻道")
    ...
    @commands.slash_command(name='volume', description="顯示/調較音量")
    async def volumeslash(self, ctx, volume=None):
        await self._volume(context=ctx, volume=volume)
    
    @commands.command(name='volume', aliases=['v'], description="顯示/調較音量")
    ...
    @commands.slash_command(name='now', description="顯示正在播放的歌曲")
    async def nowslash(self, ctx):
        await self._now(context=ctx)

    @commands.command(name='now', aliases=['current', 'playing'], description="顯示正在播放的歌曲")
    ...
    @commands.slash_command(name='pause', description="暫停歌曲")
    async def pauseslash(self, ctx):
        await self._pause(context=ctx)
    
    @commands.command(name='pause', description="暫停歌曲")
    ...
    @commands.slash_command(name='resume', description="繼續播放已暫停的音樂")
    async def resumeslash(self, ctx):
        self._resume(context=ctx)
    
    @commands.command(name='resume', aliases=['r'], description="繼續播放已暫停的音樂")
    ...
    @commands.slash_command(name='stop', description="移除所有在序列的歌曲並停止播放")
    async def stopslash(self, ctx):
        await self._stop(context=ctx)
    
    @commands.command(name='stop', description="移除所有在序列的歌曲並停止播放")
    ...
    @commands.slash_command(name='skip', description="跳過目前的歌曲")
    async def skipslash(self, ctx):
        await self._skip(context=ctx)
    
    @commands.command(name='skip', aliases=['s'], description="跳過目前的歌曲")
    ...
    @commands.slash_command(name='queue', description="顯示歌曲序列")
    async def queueslash(self, ctx, page=None):
        await self._queue(context=ctx, page=page)
    
    @commands.command(name='queue', aliases=["q"], description="顯示歌曲序列")
    ...
    @commands.slash_command(name='shuffle', description="打亂歌曲序列")
    async def shuffleslash(self, ctx):
        await self._shuffle(context=ctx)

    @commands.command(name='shuffle', description="打亂歌曲序列")
    ...
    @commands.slash_command(name='remove', description="從序列移除歌曲")
    async def removeslash(self, ctx, index=None):
        await self._remove(context=ctx, index=index)

    @commands.command(name='remove', description="從序列移除歌曲")
    ...
    @commands.slash_command(name='loop', description="調較重覆播放歌曲")
    async def loopslash(self, ctx):
        await self._loop(context=ctx)

    @commands.command(name='loop', description="調較重覆播放歌曲")
    ...
    @commands.slash_command(name='play', description="播放歌曲或歌單")
    async def playslash(self, ctx, search=None):
        await self._play(context=ctx, search=search)

    @commands.command(name='play', aliases=["p"], description="播放歌曲或歌單")
    ...
    @commands.slash_command(name='search', description="從Youtube搜尋歌曲")
    async def searchslash(self, ctx, keyword=None):
        await self.search(context=ctx, keyword=keyword)
    
    @commands.command(name='search', description="從Youtube搜尋歌曲")
    ...
    @commands.slash_command(name='musicreload', description="重新載入機器人")
    async def musicreloadslash(self, ctx):
        await self.musicreload(context=ctx)

    @commands.command(name='musicreload', description="重新載入機器人")
    ...
    @commands.slash_command(name="loopqueue", description="調較重覆播放序列")
    async def loopqueueslash(self, ctx):
        await self.loopqueue(context=ctx)
    
    @commands.command(name="loopqueue", aliases=['lq'], description="調較重覆播放序列")
    ...
    @commands.slash_command(name="seek", description="跳至指定位置")
    async def seekslash(self, ctx, seconds=None):
        await self.seek(context=ctx, seconds=seconds)
    
    @commands.command(name="seek", description="跳至指定位置")
    ...
    @commands.slash_command(name="playlist", description="管理播放清單")
    async def playlist_funcslash(self, ctx, args=None):
        await self.playlist_func(context=ctx, args=args)
    
    @commands.command(name="playlist", description="管理播放清單")
    ...
    @commands.slash_command(name="musicversion", description="顯示cog目前的版本")
    async def musicversionslash(self, ctx):
        await self.musicversion(context=ctx)

    @commands.command(name="musicversion", description="顯示cog目前的版本")
